...
private:
	...
	std::vector<olc::Pixel> colors { //Organized by order of tiles. 1 to 20
		olc::RED, olc::VERY_DARK_CYAN, olc::GREY, 
        olc::DARK_GREY, olc::VERY_DARK_GREY, olc::YELLOW, 
        olc::VERY_DARK_GREEN, olc::DARK_YELLOW, olc::CYAN,
        olc::BLUE, olc::DARK_BLUE, olc::DARK_RED,
        olc::GREEN, olc::VERY_DARK_RED, olc::DARK_GREEN,
        olc::MAGENTA, olc::DARK_MAGENTA, olc::VERY_DARK_MAGENTA,
        olc::Pixel{255,228,0}, olc::VERY_DARK_BLUE
	};
	...
	olc::Sprite *sprIsom1 = nullptr;
	olc::Sprite *sprIsom2 = nullptr;
	olc::Sprite *sprIsom3 = nullptr;
	olc::Sprite *sprIso4 = nullptr;
...
public:
	...
	{
		game_state = true;
		game_logic.setupgame();
		current = -1; //set current tile as -1

		// Load sprites used in demonstration
		sprIsom = new olc::Sprite("tiles.png");
		sprIsom1 = new olc::Sprite("player.png");
		sprIsom2 = new olc::Sprite("wumpus.png");
		sprIsom3 = new olc::Sprite("hole.png");
		sprIso4 = new olc::Sprite("bat.png");
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		DrawSprite({236,60},sprIsom2);
		DrawSprite({236,80},sprIsom3);
		DrawSprite({236,100},sprIso4);
		...
		if (GetMouse(0).bPressed)
		{
			...
			{
				std::cout<<"SHOOT\t";
				game_logic.shoot(current);
				game_state=game_logic.movearrows();
			}

			if (btnMove.clicked(GetMousePos()))
			{
				std::cout<<"MOVE\t";
				game_state=game_logic.movePlayer(current);
			}
...
int main()
{
	...
	Wumpus game_main;
	if (game_main.Construct(256, 240, 4, 4))
		game_main.Start();
